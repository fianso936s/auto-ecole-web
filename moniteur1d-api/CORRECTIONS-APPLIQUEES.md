...
### Problème
Les cookies utilisaient `sameSite: "strict"` en production, ce qui bloquait les cookies entre `api.moniteur1d.com` et `moniteur1d.com` (domaines différents).
...
### Résultat
- ✅ Les cookies fonctionnent maintenant entre `api.moniteur1d.com` et `moniteur1d.com`
